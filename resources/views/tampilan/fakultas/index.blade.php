...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-start mt-3">
                <a href="{{ route('target-fakul') }}" class="btn btn-danger btn-sm me-2 mr-2">Batal</a>
    ...
    <div class="card">
        ...
        justify-content-xl-between">
            <div class="mb-1 mr-2">
                <a href="{{ route('target-fakul.create') }}" class="btn btn-sm btn-primary">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">technopreneurship</td>
