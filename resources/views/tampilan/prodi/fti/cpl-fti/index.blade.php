            ...
            <div class="row g-4 justify-content-center align-items-stretch">
                ...
                <div class="col-md-6 col-lg-5 mb-4">
                    <div class="card h-100 shadow-sm border-0" style="min-height: 150px;">
                        <div class="card-header text-white d-flex justify-content-between align-items-center"
                            ...
                            <span style="font-size: 13px;">Aspek Sikap LAM-INFOKOM</span>
                            <div>
                ...
                <div class="col-md-6 col-lg-5 mb-4">
                    <div class="card h-100 shadow-sm border-0" style="min-height: 150px;">
                        <div class="card-header text-white d-flex justify-content-between align-items-center"
                             style="background-color: #1a71cf;">
                            <span style="font-size: 13px;">Aspek Keterampilan Umum LAM-INFOKOM</span>
                            <div>
                                <i class="fas fa-cog fa-sm mr-1"></i>
                                <i class="fas fa-ellipsis-v fa-sm"></i>
                            </div>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card h-100 shadow-sm border-0" style="min-height: 150px;">
                        <div class="card-header text-white d-flex justify-content-between align-items-center"
                             style="background-color: #1a71cf;">
                            <span style="font-size: 13px;">Aspek Keterampilan Khusus LAM-INFOKOM</span>
                            <div>
                                <i class="fas fa-cog fa-sm mr-1"></i>
                                <i class="fas fa-ellipsis-v fa-sm"></i>
                            </div>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card h-100 shadow-sm border-0" style="min-height: 150px;">
                        <div class="card-header text-white d-flex justify-content-between align-items-center"
                             style="background-color: #1a71cf;">
                            <span style="font-size: 13px;">Aspek Pengetahuan LAM-INFOKOM</span>
                            <div>
                                <i class="fas fa-cog fa-sm mr-1"></i>
                                <i class="fas fa-ellipsis-v fa-sm"></i>
                            </div>
