...
@section('content')
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <a href="{{ route('viewKK-fti') }}" class="btn btn-sm btn-success">
        ...
        <div class="card-body">
            <form action="#" method="post">
                ...
                {{-- <div class="mb-3">
                    <label for="di_upload" class="form-label">Sumber</label>
                    <select name="di_upload" class="form-control" required>
                        ...
                        <option value="UNIVERSITY_VALUE">UNIVERSITY VALUE</option>
