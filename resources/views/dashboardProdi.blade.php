...
@section('content')
    ...
    {{-- Tombol ke Rekap CPL --}}
    <div class="mb-4">
        <a href="{{ route('rekapCplProdi.grafik') }}"
    ...
    <div class="mb-4">
        <a href="{{ route('rekapRekognisiProdi.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapProdi.prestasi.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapProdi.serkom.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapProdi.hki.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapProdi.karyalainnya.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
