...
@section('content')
    ...
    {{-- Tombol ke Rekap CPL --}}
    <div class="mb-4">
        <a href="{{ route('rekapCplRektorat.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
    ...
    @if (isset($dataCPL) && count($dataCPL) > 0)
        <div class="card shadow-sm mb-4 animate__animated animate__fadeIn">
            ...
            <div class="card-body">
                <canvas id="chartCPLDashboard" height="120"></canvas>
            </div>
        </div>
    @endif

    <div class="mb-4">
        <a href="{{ route('rekapRekognisiRektorat.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    @if (!empty($rekognisiGrouped))
        <div class="card shadow-sm animate__animated animate__fadeIn mb-4">
            ...
            <div class="card-body">
                <canvas id="chartRekognisiDashboard" height="120"></canvas>
            </div>
        </div>
    @endif
    ...
    <div class="mb-4">
        <a href="{{ route('rekapRektorat.prestasi.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    @if (!empty($dataChartPrestasi))
        <div class="card shadow-sm animate__animated animate__fadeIn mb-4">
            ...
            <div class="card-body">
                <canvas id="chartPrestasiDashboard" height="120"></canvas>
            </div>
        </div>
    @endif
    ...
    <div class="mb-4">
        <a href="{{ route('rekapRektorat.serkom.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    @if (isset($labels) && count($labels) > 0)
        <div class="card shadow-sm animate__animated animate__fadeIn mb-4">
            ...
            <div class="card-body">
                <canvas id="chartSerkomDashboard" height="120"></canvas>
            </div>
        </div>
    @endif
    ...
    <div class="mb-4">
        <a href="{{ route('rekapRektorat.hki.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    @if (!empty($dataChartHki))
        <div class="card shadow-sm animate__animated animate__fadeIn mb-4">
            ...
            <div class="card-body">
                <canvas id="chartHkiDashboard" height="120"></canvas>
            </div>
        </div>
    @endif
    ...
    <div class="mb-4">
        <a href="{{ route('rekapRektorat.publikasi.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    @if (!empty($grafikPublikasi))
        <div class="card shadow-sm animate__animated animate__fadeIn mb-4">
            ...
            <div class="card-body">
                <canvas id="chartPublikasiDashboard" height="120"></canvas>
            </div>
        </div>
    @endif
    ...
    <div class="mb-4">
        <a href="{{ route('rekapRektorat.adopsi.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
            <span class="fw-semibold">Lihat Detail Karya yang Diadopsi</span>
        </a>
    </div>
    ...
    @if (!empty($grafikAdopsi))
        <div class="card shadow-sm animate__animated animate__fadeIn mb-4">
            ...
            <div class="card-body">
                <canvas id="chartAdopsiDashboard" height="120"></canvas>
            </div>
        </div>
    @endif
    ...
    <div class="mb-4">
        <a href="{{ route('rekapRektorat.karyalainnya.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    @if (!empty($grafikKaryaLain))
        <div class="card shadow-sm animate__animated animate__fadeIn mb-4">
            ...
            <div class="card-body">
                <canvas id="chartKaryaLainDashboard" height="120"></canvas>
            </div>
        </div>
    @endif
@endsection
