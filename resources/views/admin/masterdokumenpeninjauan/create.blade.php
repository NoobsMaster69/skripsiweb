        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Master Dokumen Buku Peninjauan Kurikulum</h6>
                    {{-- <a href="{{ route('master-dokumen-peninjauan') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('master-dokumen-peninjauan.store') }}" method="POST"
                        enctype="multipart/form-data" id="masterDokumenForm" novalidate>
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <div class="d-flex flex-wrap align-items-center justify-content-start gap-2">
                                <button type="submit" class="btn btn-sm btn-primary mr-2" id="submitBtn">
                                    <i class="fas fa-save mr-1"></i> <span id="submitText">Simpan</span>
                                </button>
                                <a href="{{ route('master-dokumen-peninjauan') }}"
