...
@section('content')
    ...
    <div class="mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('master-dokumen-peninjauan.index') }}">Master Dokumen</a>
                </li>
    ...
    <!-- Back Button -->
    <div class="mb-4">
        <a href="{{ route('master-dokumen-peninjauan.index') }}" class="btn btn-secondary">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form method="POST" action="{{ route('master-dokumen-peninjauan.destroy', $dokumen->id) }}">
                @csrf @method('DELETE')
