...
@section('content')
    ...
    <!-- Action Buttons -->
    <div class="mb-3">
        <a href="{{ route('master-dokumen-peninjauan.create') }}" class="btn btn-sm btn-primary shadow-sm">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h6 class="m-0 font-weight-bold text-primary">
                        ...
                        Daftar Master Dokumen Peninjauan Kurikulum
                    </h6>
                </div>
                {{-- <div class="col-md-6">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group-vertical">
                                        @if ($dokumen->fileExists())
                                            <a href="{{ route('master-dokumen-peninjauan.view', $dokumen->id) }}"
                                                class="btn btn-outline-info btn-sm mb-1" target="_blank">
                                                <i class="fas fa-eye mr-1"></i>
                                                Lihat
                                            </a>
                                            <a href="{{ route('master-dokumen-peninjauan.download', $dokumen->id) }}"
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('master-dokumen-peninjauan.edit', $dokumen->id) }}"
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <p class="text-muted">Silakan tambah data karya dosen dengan mengklik tombol "Tambah
                                        Data" di atas.</p>
                                    <a href="{{ route('master-dokumen-peninjauan.create') }}"
...
@section('scripts')
    ...
    `);
            ...
            $.ajax({
                url: '{{ route('master-dokumen-peninjauan') }}/' + id + '/detail',
                type: 'GET',
                dataType: 'json',
                            ...
                            <div class="card-body d-flex flex-column justify-content-center">
                                ...
                                <div class="btn-group-vertical">
                                    ${response.file_exists ? `
                                                    <a href="{{ route('master-dokumen-peninjauan') }}/${id}/view"
                                                       target="_blank"
                                                       class="btn btn-primary btn-sm mb-2">
                                                        <i class="fas fa-eye mr-1"></i>Lihat
                                                    </a>
                                                    <a href="{{ route('master-dokumen-peninjauan') }}/${id}/download"
        ...
        function deleteDocument(id, name) {
            ...
            $('#deleteForm').attr('action', '{{ route('master-dokumen-peninjauan') }}/' + id);
