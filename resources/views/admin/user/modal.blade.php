            ...
            <div class="modal-body text-left">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        @elseif ($item->jabatan == 'rektorat')
                            <span class="badge badge-success">{{ $item->jabatan }}</span>
                        @elseif ($item->jabatan == 'fakultas')
                            <span class="badge badge-info">{{ $item->jabatan }}</span>
                        @elseif ($item->jabatan == 'dosen')
                            <span class="badge badge-secondary">{{ $item->jabatan }}</span>
                        @elseif ($item->jabatan == 'prodi')
                            <span class="badge badge-dark">{{ $item->jabatan }}</span>
                        @else
                            <span class="badge badge-light">{{ $item->jabatan }}</span>
                        @endif
                    </div>
                </div>
