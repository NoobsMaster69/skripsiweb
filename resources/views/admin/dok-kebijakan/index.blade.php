...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
            <i class="fas fa-table mr-2"></i> Daftar Validasi Rektorat
        </h6>
    </div>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                @forelse($dokReks as $i => $DokRek)
                    <tr>
                        <td class="text-center">{{ $i+1 }}</td>
                        <td>{{ $DokRek->nomor_dokumen }}</td>
                        <td>{{ $DokRek->nama_dokumen }}</td>
                        <td class="text-center"> {!! $DokRek->upload_badge !!}</td>
                        <td class="text-center">{{ $DokRek->tanggal_upload_formatted }}</td>
                        <td class="text-center">{{ $DokRek->tanggal_pengesahan_formatted ?? '-' }}</td>
                        ...
                        <td class="text-center">
                            <a href="{{ $DokRek->getFileUrl() }}" target="_blank" class="btn btn-info btn-sm">
                                <i class="fas fa-eye"></i> Lihat
                            </a>
                        </td>
                        <td class="text-center">
                            <a href="{{ route('validasi-dok-kebijakan', $DokRek) }}" class="btn btn-success btn-sm">
