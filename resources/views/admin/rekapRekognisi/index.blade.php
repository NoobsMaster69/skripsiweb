...
@section('content')
    ...
    <a href="{{ route('rekapRekognisi.grafik') }}" class="btn btn-primary mb-3">
        📊 Lihat Grafik
    </a>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('rekapRekognisi.index') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapRekognisi.index') }}" class="btn btn-secondary btn-sm">
                            ...
                            @foreach ($rekognisiDosens as $i => $rekog)
                                <tr>
                                    ...
                                    <td class="text-center text-white">
                                        @php
                                            $warna = match ($rekog->bidang_rekognisi) {
                                                'Pendidikan' => 'success',
                                                'Penelitian' => 'info',
                                                'Pengabdian Masyarakat' => 'secondary',
                                                'Profesional' => 'warning',
                                                default => 'secondary',
                                            };
                                        @endphp
    ...
    <script>
        function exportData(type) {
            ...
            form.action = type === 'excel' ?
                "{{ route('rekapRekognisi.export') }}" :
                "{{ route('rekapRekognisi.export.pdf') }}";
