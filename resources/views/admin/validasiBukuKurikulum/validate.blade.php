...
@section('content')
    ...
    <form action="{{ route('bukuKurikulumValid.validasi', $BukuKurikulum) }}" method="POST">
        @csrf
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $BukuKurikulum->nomor_dokumen }}" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Nama Dokumen</label>
                        <input type="text" class="form-control" value="{{ $BukuKurikulum->nama_dokumen }}" readonly>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $BukuKurikulum->di_upload }}" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Tanggal Upload</label>
                        <input type="text" class="form-control" value="{{ $BukuKurikulum->tanggal_upload_formatted }}"
                            readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"
                        value="{{ $BukuKurikulum->tanggal_pengesahan_formatted ?? '-' }}" readonly>
                </div>
                    ...
                    @if ($BukuKurikulum->file_path)
                        <div class="p-3 border rounded bg-light d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="text-dark">{{ basename($BukuKurikulum->file_path) }}</span>
                            </div>
                            <a href="{{ url($BukuKurikulum->file_path) }}" target="_blank"
                ...
                <div class="d-flex justify-content-start gap-2 mt-3">
                    ...
                    <a href="{{ route('bukuKurikulumValid') }}" class="btn btn-sm btn-secondary ml-2">
