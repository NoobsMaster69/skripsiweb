                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead class="bg-primary text-white">
                        <tr class="text-center">
                            ...
                            <th>NIM</th>
                            <th>Program Studi</th> <!-- Tambahan -->
                            <th>Fakultas</th> <!-- Tambahan -->
                            <th>Tahun</th>
                            <th>Judul Karya</th>
                    ...
                    <tbody>
                        ...
                        @forelse($sertifikasiKomp as $index => $karya)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span
                                        class="badge badge-{{ $karya->tingkatan == 'internasional' ? 'danger' : ($karya->tingkatan == 'nasional' ? 'warning' : 'secondary') }}">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('validasi-serkom', $karya->id) }}" class="btn btn-success btn-sm">
