...
@section('content')
    ...
    <a href="{{ route('rekapBPM.publikasi.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapBPM.publikasi') }}" method="GET">
                <div class="row">
                    <!-- Tahun -->
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapBPM.publikasi.export.excel') }}";
            } else {
                form.action = "{{ route('rekapBPM.publikasi.export.pdf') }}";
            }
            form.submit();
        }
    </script>
