...
@section('content')
    ...
    <!-- Tombol Grafik -->
    <a href="{{ route('rekapBPM.prestasi.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapBPM.prestasi') }}" method="GET">
                <div class="row">
                    <!-- Tahun -->
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapBPM.prestasi') }}" class="btn btn-secondary btn-sm">
    ...
    @if (isset($prestasi) && request()->has('submit_filter'))
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <!-- Form Export Excel -->
                <form id="exportForm" action="{{ route('rekapBPM.prestasi.export') }}" method="GET" target="_blank"
                    class="d-none">
                ...
                <!-- Form Export PDF -->
                <form id="pdfForm" action="{{ route('rekapBPM.prestasi.export.pdf') }}" method="GET" target="_blank"
                    class="d-none">
                    <input type="hidden" name="tahun" value="{{ request('tahun') }}">
                    <input type="hidden" name="fakultas" value="{{ request('fakultas') }}">
                    <input type="hidden" name="prodi" value="{{ request('prodi') }}">
...
@push('scripts')
    <script>
        ...
        function exportToExcel() {
            ...
            window.location.href = `{{ route('rekapBPM.prestasi') }}?${params.toString()}`;
        }
