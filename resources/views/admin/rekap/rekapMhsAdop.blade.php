...
@section('content')
    ...
    <a href="{{ route('rekapBPM.adopsi.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapBPM.mhsAdopsi') }}" method="GET">
                <div class="row">
                    <!-- Tahun -->
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapBPM.mhsAdopsi') }}" class="btn btn-secondary btn-sm">
                                <i class="fas fa-undo me-1"></i> Reset
                            </a>
                        </div>
                    </div>

                    <!-- Jenis Kegiatan (Pindah ke baris baru di bawah tombol) -->
                    <div class="col-md-3 mb-3">
    ...
    @if (request()->has('submit_filter') && isset($data) && $data->count())
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('rekapBPM.mhsAdopsi.export.excel', request()->query()) }}"
                        class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Export Excel</a>
                    <a href="{{ route('rekapBPM.mhsAdopsi.export.pdf', request()->query()) }}"
                ...
                <table class="table table-bordered table-hover table-sm" id="dataTable">
                    <thead class="table-primary text-center">
                        <tr>
                            <th>No</th>
                            <th>Mahasiswa</th>
                            <th>Judul Karya Mahasiswa yang di Adopsi oleh Masyaraka</th>
                            <th>Kegiatan</th>
                            <th>Tahun</th>
                            <th>Program Studi</th>
                            <th>Fakultas</th>
