...
@section('content')
    ...
    <a href="{{ route('rekapBPM.hki.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapBPM.mhsHki') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapBPM.mhsHki') }}" class="btn btn-secondary btn-sm">
                ...
                <table class="table table-bordered table-hover table-sm" id="dataTable">
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                <td class="text-center"></td> {{-- No diisi DataTables --}}
                                <td>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                order: [
                    [6, 'desc']
                ], // urut berdasarkan tanggal (kolom ke-7, dimulai dari 0)
                columnDefs: [{
                    targets: 0, // kolom No
                    orderable: false,
                    searchable: false,
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapBPM.mhsHki.export.excel') }}";
            } else {
                form.action = "{{ route('rekapBPM.mhsHki.export.pdf') }}";
            }
            form.submit();
        }
    </script>
