...
@section('content')
    ...
    <a href="{{ route('rekapBPM.serkom.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapBPM.serkom') }}" method="GET">
                <div class="row">
                    <!-- Tahun -->
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapBPM.serkom') }}" class="btn btn-secondary btn-sm">
    ...
    <script>
        function exportData(type) {
            ...
            form.action = type === 'excel' ?
                "{{ route('rekapBPM.serkom.export.excel') }}" :
                "{{ route('rekapBPM.serkom.export.pdf') }}";
            form.submit();
        }
