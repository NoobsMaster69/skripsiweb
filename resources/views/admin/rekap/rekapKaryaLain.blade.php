...
@section('content')
    ...
    <a href="{{ route('rekapBPM.karyalainnya.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapBPM.mhsKaryaLainnya') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapBPM.mhsKaryaLainnya') }}" class="btn btn-secondary btn-sm">
                    ...
                    <tbody>
                        @foreach ($data as $i => $item)
                            <tr>
                                ...
                                <td class="text-center">{{ $item->tahun }}</td> <!-- Tambahan ini -->
                                <td>{{ $item->prodi }}</td>
                                <td>{{ $item->fakultas }}</td>
                                <td class="text-center">
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapBPM.mhsKaryaLainnya.export.excel') }}";
            } else {
                form.action = "{{ route('rekapBPM.mhsKaryaLainnya.export.pdf') }}";
            }
            form.submit();
        }
    </script>
