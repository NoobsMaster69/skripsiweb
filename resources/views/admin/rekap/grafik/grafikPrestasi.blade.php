...
@section('content')
    <div class="container">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('rekapBPM.prestasi.grafik') }}">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-auto mt-3 d-flex gap-2">
                            ...
                            <a href="{{ route('rekapBPM.prestasi.grafik') }}" class="btn btn-outline-secondary shadow-sm px-4">Reset</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="mt-4">
            <a href="{{ route('rekapBPM.prestasi') }}" class="btn btn-outline-secondary">
