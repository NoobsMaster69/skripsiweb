...
@section('content')
    ...
    <div class="mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('master-dokumen-buku.index') }}">Master Dokumen</a>
                </li>
                    ...
                    <div class="card bg-light">
                        <div class="card-body text-center">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a href="{{ route('master-dokumen-buku.download', $dokumen->id) }}"
    ...
    <!-- Back Button -->
    <div class="mb-4">
        <a href="{{ route('master-dokumen-buku.index') }}" class="btn btn-secondary">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form method="POST" action="{{ route('master-dokumen-buku.destroy', $dokumen->id) }}">
                @csrf @method('DELETE')
