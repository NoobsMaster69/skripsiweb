        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Master Dokumen Kebijakan</h6>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('master-dokumen.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    {{-- <button type="reset" class="btn btn-outline-warning ml-2" id="resetBtn">
