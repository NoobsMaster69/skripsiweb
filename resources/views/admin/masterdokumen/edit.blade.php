...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('master-dokumen') }}">Master Dokumen</a></li>
            ...
            <div class="card shadow">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-file-alt mr-2"></i> Form Edit Master Dokumen Kebijakan
                    </h6>
                    {{-- <a href="{{ route('master-dokumen') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('master-dokumen.update', $dokumen->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan"
                                rows="4" placeholder="Masukkan keterangan dokumen (opsional)">{{ old('keterangan', $dokumen->keterangan) }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <div class="btn-group" role="group">
                                ...
                                <a href="{{ route('master-dokumen') }}" class="btn btn-secondary btn-sm ml-2">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="small text-muted">Masukkan nama dokumen yang sesuai. Contoh: Kebijakan Akademik.</p>
                    </div>
                    <div class="mb-3">
                        <h6 class="font-weight-bold text-primary">File Dokumen Baru</h6>
                        <p class="small text-muted">Jika ingin mengganti file, pilih yang baru. Kosongkan jika tidak ingin
                            mengubah.</p>
                    </div>
                    <div class="mb-3">
                        <h6 class="font-weight-bold text-primary">Keterangan</h6>
                        <p class="small text-muted">Opsional. Boleh diisi untuk memberi catatan deskriptif.</p>
                    </div>
