...
@section('content')
    ...
    <!-- Action Buttons -->
    <div class="mb-3">
        <a href="{{ route('master-dokumenCreate') }}" class="btn btn-sm btn-primary">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h6 class="m-0 font-weight-bold text-primary">
                        ...
                        Daftar Master Dokumen Kebijakan
                    </h6>
                </div>
                {{-- <div class="col-md-6">
                                ...
                                <td class="text-center">
                                    <div class="btn-group-vertical">
                                        @if ($dokumen->fileExists())
                                            <a href="{{ route('master-dokumen.view', $dokumen->id) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <p class="text-muted">Silakan tambah data master dokumen dengan mengklik tombol "Tambah
                                        Data" di atas.</p>
                                    <a href="{{ route('master-dokumenCreate') }}"
...
@section('scripts')
    ...
    `);
            ...
            $.ajax({
                url: '{{ route('master-dokumen') }}/' + id + '/detail',
                type: 'GET',
                dataType: 'json',
                            ...
                            <div class="card-body d-flex flex-column justify-content-center">
                                ...
                                <div class="btn-group-vertical">
                                    ${response.file_exists ? `
                                                            <a href="{{ route('master-dokumen') }}/${id}/view"
                                                               target="_blank"
                                                               class="btn btn-primary btn-sm mb-2">
                                                                <i class="fas fa-eye mr-1"></i>Lihat
                                                            </a>
                                                            <a href="{{ route('master-dokumen') }}/${id}/download"
        ...
        function deleteDocument(id, name) {
            ...
            $('#deleteForm').attr('action', '{{ route('master-dokumen') }}/' + id);
