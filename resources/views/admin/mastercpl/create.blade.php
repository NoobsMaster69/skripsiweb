        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Form Input Data Target CPL Master BPM</h6>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('master-cplStore') }}" method="post" id="targetForm" novalidate>
                        @csrf
