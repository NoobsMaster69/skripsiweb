...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-edit mr-2 text-warning"></i>Edit {{ $title }}
        </h1>
            ...
            <div class="card shadow">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-pen mr-2"></i>Form Edit Sertifikasi Kompetensi Mahasiswa
                    </h6>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('Sertifikasi-komp-fti.update', $karya->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="prodi" id="prodi"
                                ...
                                value="{{ old('prodi', $karya->prodi) }}" placeholder="Masukkan Program Studi Mahasiswa"
                                required>
                            @error('prodi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_perolehan" id="tanggal_perolehan"
                                ...
                                value="{{ old('tanggal_perolehan', $karya->tanggal_perolehan) }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="tingkatan" id="tingkatan"
                                    ...
                                    <option value="internasional"
                                        {{ old('tingkatan', $karya->tingkatan) == 'internasional' ? 'selected' : '' }}>🌍
                                        Internasional</option>
                                    <option value="nasional"
                                        {{ old('tingkatan', $karya->tingkatan) == 'nasional' ? 'selected' : '' }}>🇮🇩
                                        Nasional</option>
                                    <option value="lokal"
                                        {{ old('tingkatan', $karya->tingkatan) == 'lokal' ? 'selected' : '' }}>🏘️ Lokal
                                    </option>
                                </select>
                                @error('tingkatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <!-- Upload File -->
                        <div class="form-group">
                            <label for="file_upload" class="font-weight-bold">Upload File Sertifikasi</label>
                            <input type="file" name="file_upload" id="file_upload"
                                class="form-control-file @error('file_upload') is-invalid @enderror"
                                accept=".pdf,.docx,.jpg,.jpeg">
                            <small class="form-text text-muted">Kosongkan jika tidak ingin mengubah file. Maks 2MB.</small>
                            @error('file_upload')
                        ...
                        <div class="d-flex justify-content-start gap-2" style="gap: 10px;">
                            ...
                            <a href="{{ route('Sertifikasi-komp-fti') }}" class="btn btn-sm btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="small text-muted">Unggah bukti sertifikasi dalam format PDF, DOCX, JPG, atau JPEG. Ukuran
                            maksimal file 2MB. Kosongkan jika tidak ingin mengubah file.</p>
                    </div>
