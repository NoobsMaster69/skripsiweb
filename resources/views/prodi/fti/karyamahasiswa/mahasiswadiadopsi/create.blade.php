        ...
        <div class="col-xl-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('mahasiswa-diadopsi-fti.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex justify-content-start gap-2">
                            ...
                            <a href="{{ route('mahasiswa-diadopsi-fti') }}" class="btn btn-sm ml-2"
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <p class="small text-muted">Isi sesuai dengan nama lengkap mahasiswa yang terdaftar di kampus.</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="font-weight-bold text-primary">🔢 NIM Mahasiswa</h6>
                        <p class="small text-muted">Masukkan Nomor Induk Mahasiswa (NIM) dengan benar, sesuai kartu
                            mahasiswa.</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="font-weight-bold text-primary">🏫 Program Studi & Fakultas</h6>
                        <p class="small text-muted">Isikan program studi dan fakultas tempat mahasiswa terdaftar. Contoh:
                            Teknik Informatika - FTI.</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="font-weight-bold text-primary">📅 Tahun</h6>
                        <p class="small text-muted">Tahun saat karya dihasilkan atau diadopsi oleh masyarakat. Contoh: 2025
                        </p>
                    </div>

                    <div class="mb-3">
                        <h6 class="font-weight-bold text-primary">🎯 Judul Karya</h6>
                        <p class="small text-muted">Masukkan judul karya yang diadopsi masyarakat secara lengkap dan
                            deskriptif.</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="font-weight-bold text-primary">🔧 Jenis Kegiatan</h6>
                        <p class="small text-muted">Pilih jenis kegiatan yang relevan: <strong>Produk</strong> atau
                            <strong>Jasa</strong>.</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="font-weight-bold text-primary">📆 Tanggal Perolehan</h6>
                        <p class="small text-muted">Tanggal resmi saat karya mahasiswa diadopsi oleh masyarakat.</p>
                    </div>

                    <div class="mb-3">
                        <h6 class="font-weight-bold text-primary">📎 Upload File Karya</h6>
                        <p class="small text-muted">Unggah dokumen bukti karya (PDF, DOCX, JPG, JPEG) maksimal ukuran 2MB.
                        </p>
                    </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="mb-0 mt-2 small">
                            <li>Pastikan seluruh data sudah benar sebelum disimpan.</li>
                            <li>File yang diunggah harus sesuai ketentuan format dan ukuran.</li>
                            <li>Data hanya akan tampil di publikasi setelah divalidasi admin.</li>
                        </ul>
                    </div>
                </div>
