...
@section('content')
    ...
    <a href="{{ route('rekapProdi.serkom.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapProdi.serkom') }}" method="GET">
                <div class="row">
                    <!-- Tahun -->
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapProdi.serkom') }}" class="btn btn-secondary btn-sm">
                    ...
                    <tbody>
                        @foreach ($sertifikasi as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ $item->tahun ?? '-' }} {{-- Tahun ditampilkan di sini --}}
                                </td>
                                <td class="text-center">
    ...
    <script>
        function exportData(type) {
            ...
            form.action = type === 'excel' ?
                "{{ route('rekapProdi.serkom.export.excel') }}" :
                "{{ route('rekapProdi.serkom.export.pdf') }}";
            form.submit();
        }
