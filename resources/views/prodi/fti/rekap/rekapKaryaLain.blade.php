...
@section('content')
    ...
    <a href="{{ route('rekapProdi.karyalainnya.grafik') }}" class="btn btn-primary mb-3">
        <i class="fas fa-chart-bar"></i> Lihat Grafik Karya Lainnya
    </a>

    <!-- Filter Form -->
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapProdi.mhsKaryaLainnya') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="fakultas" class="form-control form-control-sm">
                            ...
                            <option value="FH" {{ request('fakultas') == 'FH' ? 'selected' : '' }}>FH</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapProdi.mhsKaryaLainnya') }}" class="btn btn-secondary btn-sm">
                ...
                <table class="table table-bordered table-hover table-sm" id="dataTable">
                    <thead class="table-primary text-center">
                        <tr>
                            <th>No</th>
                            <th>Mahasiswa</th>
                            <th>Judul Karya Mahasiswa Lainnya</th>
                            <th>Kegiatan</th>
                            <th>Program Studi</th>
                            <th>Fakultas</th>
                            <th>Tahun</th>
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapProdi.mhsKaryaLainnya.exportExcel') }}";
            } else {
                form.action = "{{ route('rekapProdi.mhsKaryaLainnya.export.pdf') }}";
            }
            form.submit();
        }
    </script>
