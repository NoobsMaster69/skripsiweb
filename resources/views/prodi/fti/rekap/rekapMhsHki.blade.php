...
@section('content')
    ...
    <a href="{{ route('rekapProdi.hki.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapProdi.mhsHki') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapProdi.mhsHki') }}" class="btn btn-secondary btn-sm">
...
@section('scripts')
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapProdi.mhsHki.export.excel') }}";
            } else {
                form.action = "{{ route('rekapProdi.mhsHki.export.pdf') }}";
            }
            form.submit();
        }
    </script>
