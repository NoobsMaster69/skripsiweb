...
<head>
    <meta charset="UTF-8">
    <title>{{ $title ?? 'Laporan Data Keterampilan Khusus' }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        <h1>Laporan Data Keterampilan Khusus</h1>
    ...
    <div class="summary">
        ...
        <div class="summary-item">
            <strong>Total Keterampilan:</strong> {{ $keterampilanKhusus->count() }}
        </div>
        <div class="summary-item">
            <strong>Sumber Unik:</strong> {{ $keterampilanKhusus->groupBy('sumber')->count() }}
        </div>
    </div>
