        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Form Edit Keterampilan Khusus</h6>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kkUpdate', $kk->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" id="deskripsi"
                                ...
                                required>{{ old('deskripsi', $kk->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="card shadow border-left-info">
                ...
                <div class="card-body small">
                    ...
                    <div class="alert alert-info mt-3 mb-0">
                        <i class="fas fa-lightbulb mr-1"></i> Perbarui data dengan hati-hati sebelum menyimpan.
                    </div>
                </div>
            </div>
        </div>
