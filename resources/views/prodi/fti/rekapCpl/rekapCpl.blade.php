...
@section('content')
    ...
    <a href="{{ route('rekapCplProdi.grafik') }}" class="btn btn-primary mb-3">
            📊 Lihat Grafik
        </a>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapCPL.prodi') }}" method="GET">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapCPL.prodi') }}" class="btn btn-secondary btn-sm">
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route ('rekapCPL.prodi.export.excel') }}";
            } else {
                form.action = "{{ route ('rekapCPL.prodi.export.pdf') }}";
            }
            form.submit();
        }
    </script>
