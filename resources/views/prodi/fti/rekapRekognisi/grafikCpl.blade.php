...
@section('content')
    <div class="container">
        ...
        {{-- Filter --}}
        <form method="GET" action="{{ route('rekapRekognisiProdi.grafik') }}" class="mb-4">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-auto mt-3 d-flex gap-2">
                    ...
                    <a href="{{ route('rekapRekognisiProdi.grafik') }}" class="btn btn-outline-secondary px-4">Reset</a>
                </div>
            </div>
        </form>
