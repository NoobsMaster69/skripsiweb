...
@section('content')
    ...
    <a href="{{ route('rekapRekognisiProdi.grafik') }}" class="btn btn-primary mb-3">
        📊 Lihat Grafik
    </a>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('rekapRekognisiProdi.index') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapRekognisiProdi.index') }}" class="btn btn-secondary btn-sm">
    ...
    <script>
        function exportData(type) {
            ...
            form.action = type === 'excel' ?
                "{{ route('rekapRekognisiProdi.export') }}" :
                "{{ route('rekapRekognisiProdi.export.pdf') }}";
