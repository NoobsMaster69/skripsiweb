...
<body>
    ...
    <div class="header">
        ...
        <p>Tanggal Cetak: {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }} |
    ...
    <div class="summary">
        ...
        <div class="summary-item">
            ...
            {{ $rekognisiDosens->groupBy('tahun_akademik')->keys()->implode(', ') }}
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            @php
                $sorted = $rekognisiDosens->sortBy([['prodi', 'asc'], ['nama_dosen', 'asc']])->values();
            @endphp
