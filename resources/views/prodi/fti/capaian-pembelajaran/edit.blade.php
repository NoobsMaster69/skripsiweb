...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('master-cpl') }}">Target Rekognisi</a></li>
        ...
        <div class="col-lg-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('master-cpl.update', $masterCpl->id) }}" method="POST" id="targetForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                ...
                                <textarea name="keterangan"
                                          ...
                                          rows="3"
                                          placeholder="Tambahkan keterangan atau catatan khusus untuk target ini...">{{ old('keterangan', $masterCpl->keterangan) }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('master-cpl') }}" class="btn btn-outline-secondary mr-2">
