...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('cp-prodiftiCreate') }}">Target Rekognisi</a></li>
        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a href="{{ route('cp-prodi-fti') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('cp-prodi-ftiStore') }}" method="post" id="targetForm" novalidate>
                        @csrf
