...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-3">
        <div class="d-flex gap-5" style="gap: 10px;">
            <a href="{{ route('cp-prodiftiCreate') }}" class="btn btn-primary btn-sm">
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('cp-prodi-fti.export-excel') }}">
                    <i class="fas fa-file-excel text-success mr-1"></i> Excel
                </a>
                <a class="dropdown-item" href="{{ route('cp-prodi-fti.export-pdf') }}">
                    ...
                    <tbody>
                        @forelse ($targets as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('cp-prodi-fti.edit', $item->id) }}" class="btn btn-warning btn-sm">
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <p class="text-muted">Silakan tambah data karya dosen dengan mengklik tombol "Tambah
                                        Data" di atas.</p>
                                    <a href="{{ route('cp-prodiftiCreate') }}" class="btn btn-primary">
            ...
            <div class="mt-3">
                <div class="dropdown w-100">
                    ...
                    <div class="dropdown-menu w-100 text-center">
                        <a class="dropdown-item mb-2" href="{{ route('cp-prodi-fti.export-pdf') }}"
                            style="font-size: 1.1rem;">
                            <i class="fas fa-file-pdf text-danger mr-2 fa-lg"></i> <strong>Export PDF</strong>
                        </a>
                        <a class="dropdown-item" href="{{ route('cp-prodi-fti.export-excel') }}" style="font-size: 1.1rem;">
    ...
    <script>
        $(document).ready(function() {
            $('.btn-delete').on('click', function() {
                ...
                let url = '{{ route('cp-prodi-fti.destroy', ':id') }}'.replace(':id', id);
