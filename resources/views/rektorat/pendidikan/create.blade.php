...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('target-rek') }}">Target Rekognisi</a></li>
        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    {{-- <a href="{{ route('target-rek') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('target-rekStore') }}" method="post" id="targetForm" novalidate>
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-start align-items-center gap-2 flex-wrap">
                                    ...
                                    <a href="{{ route('target-rek') }}" class="btn btn-sm ml-2"
                                        style="background-color: #6c757d; color: white;">
                                        <i class="fas fa-arrow-left mr-1"></i> Batal
                                    </a>
                                    <div class="text-muted ml-3 mt-1">
