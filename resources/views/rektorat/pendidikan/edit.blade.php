        ...
        <div class="col-lg-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('target-rek.update', $targetRek->id) }}" method="POST" id="targetForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('tahun_akademik', $targetRek->tahun_akademik) }}"
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('program_studi', $targetRek->program_studi) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('mata_kuliah', $targetRek->mata_kuliah) }}"
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    <input type="number"
                                           ...
                                           value="{{ old('target_pencapaian', $targetRek->target_pencapaian) }}"
                                           required
                                           min="0"
                                           max="100"
                                           step="0.01"
                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                ...
                                <textarea name="keterangan"
                                          ...
                                          rows="3"
                                          placeholder="Tambahkan keterangan atau catatan khusus untuk target ini...">{{ old('keterangan', $targetRek->keterangan) }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('target-rek') }}" class="btn btn-outline-secondary mr-2">
