...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-3">
        <div class="d-flex gap-5" style="gap: 10px;">
            <a href="{{ route('target-rek.create') }}" class="btn btn-primary btn-sm">
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('target-rek.export-excel') }}">
                    <i class="fas fa-file-excel text-success mr-1"></i> Excel
                </a>
                <a class="dropdown-item" href="{{ route('target-rek.export-pdf') }}">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Data Target Rektorat</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @forelse ($targets as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('target-rek.edit', $item->id) }}" class="btn btn-warning btn-sm">
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <p class="text-muted">Silakan tambah data karya dosen dengan mengklik tombol "Tambah
                                        Data" di atas.</p>
                                    <a href="{{ route('target-rek.create') }}" class="btn btn-primary">
            ...
            <div class="mt-3">
                <div class="dropdown w-100">
                    ...
                    <div class="dropdown-menu w-100 text-center">
                        <a class="dropdown-item mb-2" href="{{ route('target-rek.export-pdf') }}"
        ...
        <script>
            $(document).ready(function() {
                $('.btn-delete').on('click', function() {
                    ...
                    $('#deleteForm').attr('action', '{{ route('target-rek.destroy', ':id') }}'.replace(':id',
                        id));
                });
            });
        </script>
