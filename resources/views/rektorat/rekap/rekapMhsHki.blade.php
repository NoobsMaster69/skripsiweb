...
@section('content')
    ...
    <a href="{{ route('rekapRektorat.hki.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapRektorat.mhsHki') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapRektorat.mhsHki') }}" class="btn btn-secondary btn-sm">
                ...
                <table class="table table-bordered table-hover table-sm" id="dataTable">
                    ...
                    <tbody>
                        @foreach ($data as $i => $item)
                            <tr>
                                <td class="text-center"></td> {{-- akan diisi otomatis oleh DataTables --}}
                                <td>
...
@section('scripts')
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapRektorat.mhsHki.export.excel') }}";
            } else {
                form.action = "{{ route('rekapRektorat.mhsHki.export.pdf') }}";
            }
            form.submit();
        }
    </script>
