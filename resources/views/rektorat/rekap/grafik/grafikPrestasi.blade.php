...
@section('content')
    <div class="container">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('rekapRektorat.prestasi.grafik') }}">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="d-flex gap-2">
                                <input type="number" name="periode_dari" class="form-control" placeholder="Dari tahun"
                                    value="{{ request('periode_dari') }}">
                                <span class="pt-2">-</span>
                                <input type="number" name="periode_sampai" class="form-control" placeholder="Sampai tahun"
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="tingkat" class="form-control">
                                ...
                                <option value="3" {{ request('tingkat') == '3' ? 'selected' : '' }}>Internasional
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3 mt-4">
                            ...
                            <select name="jenis_prestasi" class="form-control">
                                ...
                                <option value="prestasi-akademik"
                                    {{ request('jenis_prestasi') == 'prestasi-akademik' ? 'selected' : '' }}>Akademik
                                </option>
                                <option value="prestasi-non-akademik"
                                    {{ request('jenis_prestasi') == 'prestasi-non-akademik' ? 'selected' : '' }}>Non
                                    Akademik</option>
                            </select>
                        </div>
