...
<head>
    <meta charset="utf-8">
    <title>{{ $title ?? 'Laporan HKI Mahasiswa' }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Laporan Hak Kekayaan Intelektual (HKI) Mahasiswa<br>Universitas Catur Insan Cendekia</h1>
    ...
    <div class="footer">
        ...
        <p>LAPORAN HKI MAHASISWA - REKTORAT UCIC</p>
    </div>
</body>
</html>
