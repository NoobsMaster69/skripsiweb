...
@section('content')
    ...
    <a href="{{ route('rekapRektorat.publikasi.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapRektorat.publikasi') }}" method="GET">
                <div class="row">
                    <!-- Tahun -->
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapRektorat.publikasi') }}" class="btn btn-secondary btn-sm">
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapRektorat.publikasi.export.excel') }}";
            } else {
                form.action = "{{ route('rekapRektorat.publikasi.export.pdf') }}";
            }
            form.submit();
        }
    </script>
