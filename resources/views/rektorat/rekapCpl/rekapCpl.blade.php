...
@section('content')
    ...
    <a href="{{ route('rekapCplRektorat.grafik') }}" class="btn btn-primary mb-3">
        📊 Lihat Grafik
    </a>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapCPL.rektorat') }}" method="GET">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapCPL.rektorat') }}" class="btn btn-secondary btn-sm">
                    ...
                    <tbody>
                        @foreach ($targets as $i => $item)
                            <tr>
                                ...
                                <td class="text-center text-nowrap">{{ $item->tahun_akademik }}</td>
                                <td class="text-nowrap">{{ $item->program_studi }}</td>
                                <td class="text-nowrap">{{ $item->mata_kuliah }}</td>
                                ...
                                <td class="text-center text-nowrap">
                                    @if (optional($item->cplDosen)->link)
                                        <a href="{{ optional($item->cplDosen)->link }}" target="_blank"
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapCPL.rektorat.export.excel') }}";
            } else {
                form.action = "{{ route('rekapCPL.rektorat.export.pdf') }}";
            }
            form.submit();
        }
    </script>
