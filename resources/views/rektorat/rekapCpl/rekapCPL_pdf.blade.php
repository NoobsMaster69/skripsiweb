...
<head>
    <meta charset="utf-8">
    <title>{{ $title ?? 'Laporan Rekap CPL Rektorat' }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Laporan Rekap Capaian Pembelajaran Lulusan (CPL)<br>Universitas Catur Insan Cendekia</h1>
    ...
    <div class="footer">
        ...
        <p>LAPORAN REKAP CPL REKTORAT - REKTORAT UCIC</p>
    </div>
</body>
</html>
