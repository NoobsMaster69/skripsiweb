...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('target-fakul') }}">Target Rekognisi</a></li>
        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Form Input Data Target</h6>
                    {{-- <a href="{{ route('target-fakul') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dok-rekStore') }}" method="post" id="targetForm" novalidate>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="tahun_akademik" id="tahun_akademik"
                                    ...
                                    value="{{ old('tahun_akademik') }}" placeholder="Contoh: 2024/2025" maxlength="9"
                                    required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="mata_kuliah" id="mata_kuliah"
                                    ...
                                    value="{{ old('mata_kuliah') }}" placeholder="Contoh: Algoritma dan Pemrograman"
                                    required>
                                @error('mata_kuliah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    <input type="number" name="target_pencapaian" id="target_pencapaian"
                                        ...
                                        value="{{ old('target_pencapaian') }}" required min="0" max="100"
                                        step="0.01" placeholder="Contoh: 85.50">
                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                ...
                                <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                                    rows="3" placeholder="Tambahkan keterangan atau catatan khusus untuk target ini...">{{ old('keterangan') }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-start align-items-center gap-2 flex-wrap">
                                    ...
                                    <a href="{{ route('target-fakul') }}" class="btn btn-sm ml-2"
                                        style="background-color: #6c757d; color: white;">
                                        <i class="fas fa-times mr-1"></i> Batal
                                    </a>
                                    <div class="text-muted mt-1 ml-3">
                                        <small><span class="text-danger">*</span> Field wajib diisi</small>
                                    </div>
                                </div>
                            </div>
                        </div>
