...
@section('content')
    ...
    <a href="{{ route('rekapFakul.adopsi.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapFakul.mhsAdopsi') }}" method="GET">
                <div class="row">
                    <!-- Tahun -->
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapFakul.mhsAdopsi') }}" class="btn btn-secondary btn-sm">
    ...
    @if (request()->has('submit_filter') && isset($data) && $data->count())
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('rekapFakul.mhsAdopsi.export.excel', request()->query()) }}"
                        class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Export Excel</a>
                    <a href="{{ route('rekapFakul.mhsAdopsi.export.pdf', request()->query()) }}"
