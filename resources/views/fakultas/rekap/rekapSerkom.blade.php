...
@section('content')
    ...
    <a href="{{ route('rekapFakul.serkom.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapFakul.serkom') }}" method="GET">
                <div class="row">
                    <!-- Tahun -->
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapFakul.serkom') }}" class="btn btn-secondary btn-sm">
    ...
    @if (request()->has('submit_filter') && $sertifikasi && $sertifikasi->count())
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="m-0 text-primary">Data Sertifikasi Kompetensi Mahasiswa</h6>
                <div>
                ...
                <table class="table table-bordered table-hover table-sm" id="dataTable">
                    <thead class="table-primary text-center">
                        <tr>
                            <th>No</th>
                            <th>Mahasiswa</th>
                            <th>Judul Sertifikasi Kompetensi Mahasiswa</th>
                            <th>Kegiatan</th>
                            <th>Tingkatan</th>
                            <th>Tahun</th>
                            <th>Tanggal</th>
                        ...
                        @foreach ($sertifikasi as $i => $item)
                            <tr>
                                ...
                                <td class="text-center"><span
                                        class="badge bg-info text-white">{{ $item->kegiatan }}</span>
                                </td>
...
@section('scripts')
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (dataTableElement && dataTableElement.rows.length > 1) {
                // Cek apakah DataTable sudah aktif
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route ('rekapFakul.serkom.export.excel') }}";
            } else {
                form.action = "{{ route ('rekapFakul.serkom.export.pdf') }}";
            }
            form.submit();
        }
    </script>
