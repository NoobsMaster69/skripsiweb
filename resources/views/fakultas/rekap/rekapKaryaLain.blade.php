...
@section('content')
    ...
    <a href="{{ route('rekapFakul.karyalainnya.grafik') }}" class="btn btn-primary mb-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapFakul.mhsKaryaLainnya') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapFakul.mhsKaryaLainnya') }}" class="btn btn-secondary btn-sm">
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapFakul.mhsKaryaLainnya.export.excel') }}";
            } else {
                form.action = "{{ route('rekapFakul.mhsKaryaLainnya.export.pdf') }}";
            }
            form.submit();
        }
    </script>
