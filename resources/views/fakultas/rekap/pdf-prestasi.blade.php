...
<head>
    ...
    <style>
        ...
        .header {
            text-align: center;
            margin-bottom: 25px;
            border-bottom: 2px solid #1d5fb4;
            padding-bottom: 15px;
        }
        .header h1 {
            font-size: 16px;
...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-item">
            <strong>Total Mahasiswa:</strong> {{ $publikasi->count() }}
        </div>
        <div class="summary-item">
            <strong>Jumlah Prodi:</strong> {{ $publikasi->groupBy('prodi')->count() }}
        </div>
        <div class="summary-item">
            <strong>Tingkatan Sertifikasi:</strong> {{ $publikasi->groupBy('tingkat')->count() }}
        </div>
    </div>
    ...
    <div class="footer">
        ...
        <p>LAPORAN SERTIFIKASI KOMPETENSI MAHASISWA - FAKULTAS UCIC</p>
    </div>
</body>
</html>
