...
@section('content')
    <div class="container mt-4">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('rekapFakul.hki.grafik') }}">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-auto mt-3 d-flex gap-2">
                            ...
                            <a href="{{ route('rekapFakul.hki.grafik') }}" class="btn btn-outline-secondary shadow-sm px-4">
        ...
        {{-- Tombol Kembali --}}
        <div class="mt-4">
            <a href="{{ route('rekapFakul.mhsHki') }}" class="btn btn-outline-secondary">
