...
@section('content')
    <div class="container">
        ...
        {{-- Filter --}}
        <form method="GET" action="{{ route('rekapRekognisiFakultas.grafik') }}" class="mb-4">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-auto mt-3 d-flex gap-2">
                    ...
                    <a href="{{ route('rekapRekognisiFakultas.grafik') }}" class="btn btn-outline-secondary px-4">Reset</a>
                </div>
            </div>
        </form>
        ...
        {{-- Tombol Kembali --}}
        <div class="mt-4">
            <a href="{{ route('rekapRekognisiFakul.index') }}" class="btn btn-outline-secondary">← Kembali ke Tabel Rekap</a>
            <a href="{{ route('fakultas.dashboard') }}" class="btn btn-primary">
