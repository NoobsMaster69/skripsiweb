...
@section('content')
    ...
    <a href="{{ route('rekapCplFakultas.grafik') }}" class="btn btn-primary mb-3">
        📊 Lihat Grafik
    </a>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('rekapCPL.fakul') }}" method="GET">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="mata_kuliah" id="mata_kuliah" class="form-control form-control-sm"
                            value="{{ request('mata_kuliah') }}" placeholder="Contoh: Algoritma Pemrograman">
                    </div>
                    ...
                    <div class="col-md-3 mb-3 d-flex align-items-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('rekapCPL.fakul') }}" class="btn btn-secondary btn-sm">
    ...
    <script>
        function exportData(type) {
            ...
            if (type === 'excel') {
                form.action = "{{ route('rekapCPL.fakultas.export.excel') }}";
            } else {
                form.action = "{{ route('rekapCPL.fakultas.export.pdf') }}";
            }
            form.submit();
        }
    </script>
