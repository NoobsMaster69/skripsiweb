...
@section('content')
    <div class="container">
        ...
        {{-- Filter Tahun --}}
        <form method="GET" action="{{ route('rekapCplFakultas.grafik') }}" class="mb-4">
            <div class="row g-3">
                {{-- Kolom Tahun (Tunggal) --}}
                <div class="col-md-3">
                ...
                <div class="col-md-2 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('rekapCplFakultas.grafik') }}" class="btn btn-outline-secondary shadow-sm w-100">Reset</a>
                </div>
            </div>
        </form>
        ...
        <div class="mt-4 d-flex gap-3" style="gap: 10px;">
            <a href="{{ route('rekapCPL.fakul') }}" class="btn btn-secondary">
