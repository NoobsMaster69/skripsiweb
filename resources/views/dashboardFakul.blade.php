...
@section('content')
    ...
    {{-- Tombol ke Rekap CPL --}}
    <div class="mb-4">
        <a href="{{ route('rekapCplFakultas.grafik') }}"
    ...
    <div class="mb-4">
        <a href="{{ route('rekapRekognisiFakultas.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapFakul.prestasi.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapFakul.serkom.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapFakul.hki.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapFakul.publikasi.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapFakul.adopsi.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
    ...
    <div class="mb-4">
        <a href="{{ route('rekapFakul.karyalainnya.grafik') }}"
            class="btn btn-lg text-white d-inline-flex align-items-center gap-2 shadow-sm"
            style="background: linear-gradient(135deg, #4e73df, #1cc88a); border-radius: 8px; padding: 12px 20px;">
            <i class="fas fa-chart-bar fa-lg"></i>
