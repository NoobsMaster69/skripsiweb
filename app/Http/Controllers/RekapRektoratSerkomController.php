...
class RekapRektoratSerkomController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap Rektorat "Sertifikasi Kompetensi Mahasiswa"';
        ...
        return view('rektorat.rekap.rekapSerkom', compact(
            'title',
            'sertifikasi',
            'jumlahInternasional',
            'jumlahNasional',
    ...
    public function grafik(Request $request)
    {
        ...
        $listTahun = SertifkompMahasiswa::distinct()->orderBy('tahun', 'desc')->pluck('tahun');
        $listProdi = SertifkompMahasiswa::distinct()->pluck('prodi')->filter()->values();
        $listFakultas = SertifkompMahasiswa::distinct()->pluck('fakultas')->filter()->values();


        return view('rektorat.rekap.grafik.grafikSerkom', compact(
            'title',
            'labels',
            'datasetLokal',
            'datasetNasional',
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('rektorat.rekap.serkom_pdf', ['data' => $data])
