...
class RekapProdipublikasiController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap BPM Publikasi Mahasiswa';

        // Cek hanya jika tombol "Tampilkan Data" diklik
    ...
    public function exportExcel(Request $request)
    {
        ...
        $data = $query->get(); // INI Collection, bukan array biasa
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('prodi.fti.rekap.publikasi_pdf', compact('data'))->setPaper('A4', 'landscape');
    ...
    public function grafik(Request $request)
    {
        ...
        return view('prodi.fti.rekap.grafik.grafikPublikasi', compact(
            'title',
            'grafikData',
            'listTahun',
            'listProdi',
