...
class MasterDokumentPeninjauanController extends Controller
{
    public function index()
    {
        $dokumens = MasterDokumenPeninjauan::orderBy('nomor', 'asc')->get();

        $data = array(
            "title"         => "Master Dokumen Buku Peninjauan Kurikulum",
    ...
    {
        $data = array(
            'title'             => 'Tambah Master Dokumen Buku Peninjauan Kurikulum',
            'menuTargetRek'     => 'active',
        );
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $uploadPath = 'uploads/master-dokumen-peninjauan';
            ...
            // Save to database
            MasterDokumenPeninjauan::create([
                'nomor' => $request->nomor,
                'nama' => $request->nama,
                'file_path' => $filePath,
            ...
            return redirect()->route('master-dokumen-peninjauan')
    ...
    {
        $dokumen = MasterDokumenPeninjauan::findOrFail($id);
        ...
        return view('admin/masterdokumenpeninjauan/show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $data = array(
            'title' => 'Edit Master Dokumen Buku Peninjauan Kurikulum',
            'menuTargetRek' => 'active',
            'dokumen' => $dokumen,
        );

        return view('admin/masterdokumenpeninjauan/edit', $data);
    }
    ...
    public function indexProdi()
    {
        ...
        return view('prodi.fti.masterdokumenpeninjauan.index', [
            'title' => 'Dokumen Peninjauan Kurikulum',
            'dokumens' => $dokumens
        ]);
    }
}
