...
class RekapCPLrektoratController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap CPL Rektorat';

        $targets = collect(); // Default kosong
        ...
        if ($request->has('submit_filter')) {
            ...
            if ($request->filled('mata_kuliah')) {
                $query->where('mata_kuliah', 'like', '%' . $request->mata_kuliah . '%'); // ← ini yang penting
            }
        ...
        return view('rektorat.rekapCpl.rekapCpl', compact('title', 'targets', 'listTahun', 'listProdi', 'listMatkul'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('rektorat.rekapCpl.rekapCPL_pdf', compact('data'));
        return $pdf->download('rekap_rektorat_cpl.pdf');
    }
     public function grafik(Request $request)
    {
        ...
        return view('rektorat.rekapCpl.grafikCpl', compact('title', 'data', 'listTahun', 'listMatkul'));
    }
}
