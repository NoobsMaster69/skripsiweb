...
class RekapCPLprodiController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap CPL Prodi';
        ...
        return view('prodi.fti.rekapCpl.rekapCpl', compact('title', 'targets', 'listTahun', 'listProdi', 'listMatkul'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('prodi.fti.rekapCpl.rekapCPL_pdf', compact('data'));
        return $pdf->download('rekap_cpl_prodi.pdf');
    }
    public function grafik(Request $request)
    {
        ...
        return view('prodi.fti.rekapCpl.grafikCpl', compact('title', 'data', 'listTahun', 'listMatkul'));
    }
}
