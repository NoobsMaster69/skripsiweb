...
class RekapProdimhsHkiController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap Prodi "Mahasiswa yang mendapatkan HKI"';
        $data = null;

        // Cek apakah tombol "Tampilkan Data" diklik
        $isFiltered = $request->has('submit_filter') && $request->isMethod('GET');

        if ($isFiltered) {
            $query = MahasiswaHki::query()->where('kegiatan', 'HKI')->where('status', 'terverifikasi');
        ...
        return view('prodi.fti.rekap.rekapMhsHki', compact('title', 'data', 'request', 'listTahun', 'listProdi'));
    }
    ...
    public function exportPDF(Request $request)
    {
        ...
        return Pdf::loadView('prodi.fti.rekap.hki_pdf', compact('data', 'tanggalCetak'))
    ...
    public function grafik(Request $request)
    {
        ...
        return view('prodi.fti.rekap.grafik.grafikMhsHki', compact(
            'title',
            'labels',
            'dataChart',
            'listTahun',
