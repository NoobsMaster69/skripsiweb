...
class RekapBPMmhsKaryalainnyaController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap BPM Karya Mahasiswa Lainnya';

        // Selama tombol submit_filter diklik, tampilkan data (dengan atau tanpa filter)
        ...
        return view('admin.rekap.rekapKaryaLain', compact('title', 'data', 'request', 'listProdi', 'listTahun'));
    }
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('admin.rekap.karyalainnya_pdf', compact('data'))->setPaper('A4', 'landscape');
