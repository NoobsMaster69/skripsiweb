...
class RekapBPMmhsAdopsiController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap BPM Karya Mahasiswa yang di Adopsi oleh Masyarakat';
        ...
        return view('admin.rekap.rekapMhsAdop', compact(
            'title',
            'data',
            'request',
            'listProdi',
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(
            new RekapMahasiswaAdopsimasyExport($filters),
            'Rekap_Mahasiswa_Adopsi.xlsx'
        );
    }
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('admin.rekap.mhsadopsi_pdf', [
            'data' => $data,
    ...
    public function grafik(Request $request)
    {
        ...
        return view('admin.rekap.grafik.grafikMhsAdopsi', compact(
            'title',
            'grafikData',
            'listTahun',
            'listProdi',
