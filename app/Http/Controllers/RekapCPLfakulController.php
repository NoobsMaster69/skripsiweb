...
class RekapCPLfakulController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap CPL Fakultas';
        ...
        return view('fakultas.rekapCpl.rekapCpl', compact('title', 'targets', 'listTahun', 'listProdi', 'listMatkul'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('fakultas.rekapCpl.rekapCPL_pdf', compact('data'));
        return $pdf->download('rekap_Fakultas_cpl.pdf');
    }
    public function grafik(Request $request)
    {
        ...
        return view('fakultas.rekapCpl.grafikCpl', compact('title', 'data', 'listTahun', 'listMatkul'));
    }
}
