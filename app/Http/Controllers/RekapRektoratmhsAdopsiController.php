...
class RekapRektoratmhsAdopsiController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap Rektorat "Karya Mahasiswa yang di Adopsi oleh Masyarakat"';
        ...
        return view('rektorat.rekap.rekapMhsAdop', compact('title', 'data', 'request','listProdi','listTahun'));
    }
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('rektorat.rekap.mhsadopsi_pdf', [
            'data' => $data,
    ...
    public function grafik(Request $request)
    {
        ...
        return view('rektorat.rekap.grafik.grafikMhsAdopsi', compact(
            'title',
            'grafikData',
            'listTahun',
            'listProdi',
