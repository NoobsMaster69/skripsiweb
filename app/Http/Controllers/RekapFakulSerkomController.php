...
class RekapFakulSerkomController extends Controller
{
     public function index(Request $request)
    {
        $title = 'Rekap Fakultas "Sertifikasi Kompetensi Mahasiswa"';
        ...
        return view('fakultas.rekap.rekapSerkom', compact(
            'title',
            'sertifikasi',
            'jumlahInternasional',
            'jumlahNasional',
    ...
    public function grafik(Request $request)
    {
        ...
        return view('fakultas.rekap.grafik.grafikSerkom', compact(
            'title',
            'labels',
            'datasetLokal',
            'datasetNasional',
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('fakultas.rekap.serkom_pdf', ['data' => $data])
