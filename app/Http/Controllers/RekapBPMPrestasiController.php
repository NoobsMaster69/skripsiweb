...
class RekapBPMPrestasiController extends Controller
{
    ...
    {
        $title = 'Rekap BPM Prestasi Mahasiswa';
        $prestasi = collect();

        if ($request->isMethod('GET') && $request->has('submit_filter')) {
        ...
        return view('admin.rekap.rekapPrestasi', compact('title', 'prestasi', 'request', 'listProdi', 'listTahun'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('admin.rekap.pdf-prestasi', [
            'data' => $data,
