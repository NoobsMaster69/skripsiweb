...
class RekapRektoratmhsHkiController extends Controller
{
    public function index(Request $request)
    {
        $title = 'Rekap Rektorat "Mahasiswa yang mendapatkan HKI"';
        ...
        return view('rektorat.rekap.rekapMhsHki', compact(
            'title',
            'data',
            'request',
            'listTahun',
    ...
    public function exportPDF(Request $request)
    {
        ...
        return Pdf::loadView('rektorat.rekap.hki_pdf', compact('data', 'tanggalCetak'))
    ...
    public function grafik(Request $request)
    {
        ...
        return view('rektorat.rekap.grafik.grafikMhsHki', compact(
            'title',
            'labels',
            'dataChart',
            'listTahun',
